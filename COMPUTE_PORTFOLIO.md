...
wall per scaffold), and **Ramp B-2 4e/5o (8-qubit) full NM closure 5/6** (LiH
790 µHa + clc1/sar1/mfn2/hd6 in chem-acc; gjb1 4e/5o stalls — gradient-free NM
cost on 876-Pauli/54-param, externalized fall-back); 1 live orchestrator (xeno
...
five sub-tiers — see §4. Open ramps: gjb1 4e/5o externalized convergence /
...
| **qmirror chemistry-VQE — Ramp B-2 4e/5o (8-qubit) full NM, 5/6 in-process** | full variational VQE on 8-qubit ParityMapper((2,2)) 4e/5o Hamiltonians for LiH + 5 CMT — same RFC 034+035 plumbing, n_qubits-generic. The 4e/5o tier extends the active-space ladder by one orbital and bumps Hamiltonian size from ~325 to 876 Pauli terms / 54 UCCSD params. | ✅ **live (Ramp B-2 5/6 LANDED) 2026-05-13** | `qmirror/chemistry_vqe/module/chemistry_vqe_cmt_uccsd_<name>_4e5o.hexa` × 6 + gates `selftest/cmt_uccsd_lih_4e5o_readiness.sh` + `selftest/cmt_uccsd_4e5o_readiness.sh` (the latter exports `HEXA_MEM_CAP_MB=2048` — 876-Pauli arena needs more headroom). Live: LiH 790 µHa @ 9s, clc1 457 / sar1 630 / mfn2 311 / hd6 15 µHa @ ~30-42s. gjb1 4e/5o stalls at 4893 µHa @ maxiter=500 (halves to 2386 µHa @ maxiter=1000 — gradient-free NM cost on this scaffold); offline qiskit-SLSQP reaches 36 µHa, in-process NM deferred to externalized fall-back. |
| **qmirror chemistry-VQE — final-molecule / pocket-embedded, gjb1 4e/5o externalized** | (i) gjb1 4e/5o externalized convergence (oneshot pattern parallel to LiH 4e/4o externalized); (ii) final-molecule geometries (post Phase-β chemotype refinement); (iii) pocket-embedded QM/MM-VQE — the actual K_d/ΔΔG, not the frontier-orbital token. | ⏳ **open ramps** | (i) Mechanical via existing oneshot driver pattern. (ii) Chemistry judgment. (iii) Research-grade QM/MM, out of in-repo scope. Documented in `~/core/qmirror/CHEMISTRY_VQE_PYSCF_BACKEND_PLAN_2026_05_12.md` §4-5; see §4 below. |
