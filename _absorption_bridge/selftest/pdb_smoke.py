...
# -*- coding: utf-8 -*-
"""
pdb_smoke.py — selftest wrapper invoking the pdb adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_PDB_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "pdb/pdb_api_smoke.py"
SENTINEL = "__HEXA_BIO_PDB_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_PDB_API_SMOKE__"
