...
# -*- coding: utf-8 -*-
"""
openfold_smoke.py — selftest wrapper invoking the openfold adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_OPENFOLD_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "openfold/openfold_smoke.py"
SENTINEL = "__HEXA_BIO_OPENFOLD_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_OPENFOLD_SMOKE__"
