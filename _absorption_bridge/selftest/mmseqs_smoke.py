...
# -*- coding: utf-8 -*-
"""
mmseqs_smoke.py — selftest wrapper invoking the mmseqs adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_MMSEQS_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "mmseqs/mmseqs_smoke.py"
SENTINEL = "__HEXA_BIO_MMSEQS_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_MMSEQS_SMOKE__"
