...
# -*- coding: utf-8 -*-
"""
rosettafold_smoke.py — selftest wrapper invoking the rosettafold adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_ROSETTAFOLD_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "rosettafold/rosettafold_smoke.py"
SENTINEL = "__HEXA_BIO_ROSETTAFOLD_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_ROSETTAFOLD_SMOKE__"
