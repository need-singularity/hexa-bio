...
# -*- coding: utf-8 -*-
"""
foldseek_smoke.py — selftest wrapper invoking the foldseek adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_FOLDSEEK_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "foldseek/foldseek_smoke.py"
SENTINEL = "__HEXA_BIO_FOLDSEEK_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_FOLDSEEK_SMOKE__"
