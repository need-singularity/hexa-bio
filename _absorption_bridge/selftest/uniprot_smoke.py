...
# -*- coding: utf-8 -*-
"""
uniprot_smoke.py — selftest wrapper invoking the uniprot adapter
offline fixture replay.

Emits sentinel: __HEXA_BIO_UNIPROT_SMOKE__ PASS / FAIL.
...
ADAPTER = HERE.parent / "uniprot/uniprot_api_smoke.py"
SENTINEL = "__HEXA_BIO_UNIPROT_SMOKE__"
INNER_SENTINEL = "__HEXA_BIO_UNIPROT_API_SMOKE__"
